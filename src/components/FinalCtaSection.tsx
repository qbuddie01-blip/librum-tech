...
export const FinalCtaSection: React.FC<FinalCtaSectionProps> = ({ onRouteChange }) => {
  return (
    <section className="py-24 relative overflow-hidden bg-[#0A192F] text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900 border border-slate-700 text-xs font-heading font-semibold text-amber-400 mb-6 shadow-sm">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900/80 border border-slate-700 hover:border-slate-500 text-white font-heading font-semibold text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2 cursor-pointer hover:bg-slate-900"
          >
        ...
        {/* Contact Strip */}
        <div className="mt-14 pt-8 border-t border-slate-800 flex flex-wrap items-center justify-center gap-8 text-xs font-mono text-slate-400">
          <a 
